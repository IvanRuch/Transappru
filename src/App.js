    ...
    return (
      <NavigationContainer>
        <Stack.Navigator screenOptions={{ headerShown: false }}>
          ...
          <Stack.Screen name="Inn" component={Inn} />
          <Stack.Screen name="Main" component={Main} />
          <Stack.Screen name="AutoList" component={AutoList} />
          <Stack.Screen name="Auto" component={Auto} />
          <Stack.Screen name="AutoFine" component={AutoFine} />
          <Stack.Screen name="User" component={User} />
          <Stack.Screen name="DelUser" component={DelUser} />
          <Stack.Screen name="InviteUser" component={InviteUser} />
          <Stack.Screen name="AutoDriver" component={AutoDriver} />
          <Stack.Screen name="Pass" component={Pass} />
          <Stack.Screen name="PassYaMap" component={PassYaMap} />
