...
class OnBoarding extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      screen_current: {
        msg: '',
        src: require('../../../assets/images/1x1.png')
      },
  ...
  renderEllipseItem = (item, index) => {
    ...
    return (
      ...
      index == this.state.current ? (
          <Image key={index} style={{ margin: 5 }} source={require('../../../assets/images/ellipse_active_2.png')} />
        ) : (
          <Image key={index} style={{ margin: 5 }} source={require('../../../assets/images/ellipse_2.png')} />
        )
