...
Status: Draft (план, не реализовано). Снимает часть latency-боли до миграции
(backend-takeover), не трогая legacy Ивана.
Date: 2026-06-21
...
## Verified (заполнить при реализации)

- [ ] `npx tsc --noEmit` 0 errors
- [ ] `npx jest` целевые suite зелёные
- [ ] Ручная сверка: лёгкий refresh не ломает счётчики/профиль/нотификации
